...
//          -----------------------Venue Column--------------------------------
            ...
            Label Venue2 = new Label("CPELT");
            Venue2.setFont(new Font("Calibri",15)); 
            
            VBox venue = new VBox(10);
            venue.getChildren().addAll(Venue1, Venue2);
...
//         -------------------------Course Title Column-----------------------------
            ...
            courseTitle.getChildren().addAll(courseTitle1, courseTitle2);
...
//         -------------------------Course Unit Column-----------------------------
            ...
            courseUnit.getChildren().addAll(courseUnit1, courseUnit2);
...
//          -----------------------Venue Column--------------------------------
            Label Venue1 = new Label("Venue 1");
            Venue1.setFont(new Font("Calibri",15));
